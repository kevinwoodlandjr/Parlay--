    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
      <div className="bg-surface rounded-2xl border border-border max-w-md w-full overflow-hidden">
        <div className="px-5 py-4 border-b border-border">
          <p className="text-fg-muted text-xs font-semibold uppercase tracking-wider">Shared Parlay</p>
          <h2 className="text-fg font-bold text-lg mt-1">
        ...
        <div className="divide-y divide-border">
          {parlayData.legs.map((leg, i) => (
            <div key={i} className="px-5 py-3 flex items-center justify-between">
              <div>
                <p className="text-fg text-sm font-medium">{leg.description}</p>
        ...
        <div className="px-5 py-4 border-t border-border space-y-2">
          <div className="flex justify-between text-sm">
            <span className="text-fg-muted">Wager</span>
            <span className="text-fg font-semibold">{formatCurrency(parlayData.wager)}</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-fg-muted">Parlay Odds</span>
          ...
          <div className="flex justify-between bg-green/10 rounded-lg px-3 py-2 mt-2">
            <span className="text-fg-muted text-sm">Potential Payout</span>
